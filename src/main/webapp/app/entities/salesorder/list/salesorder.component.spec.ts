...
import { sampleWithRequiredData } from '../salesorder.test-samples';
...
describe('Salesorder Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, SalesorderComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to salesorderService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getSalesorderIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getSalesorderIdentifier).toHaveBeenCalledWith(entity);
