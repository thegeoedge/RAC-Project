...
import { sampleWithRequiredData } from '../taxes.test-samples';
...
describe('Taxes Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, TaxesComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to taxesService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTaxesIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getTaxesIdentifier).toHaveBeenCalledWith(entity);
