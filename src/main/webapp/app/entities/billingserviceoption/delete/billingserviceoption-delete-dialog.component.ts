...
@Component({
  standalone: true,
  templateUrl: './billingserviceoption-delete-dialog.component.html',
  imports: [SharedModule, FormsModule],
})
export class BillingserviceoptionDeleteDialogComponent {
  ...
  confirmDelete(id: number): void {
    this.billingserviceoptionService.delete(id).subscribe(() => {
